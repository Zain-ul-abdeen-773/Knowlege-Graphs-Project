...
\title{
    ...
    \vspace{0.5cm}
    \large PKG2020 Knowledge Graph: \\
    \large A Linked Data Approach to Bibliometric Research Data
}
...
\author{
    ...
    \vspace{0.5cm} \\
    \textbf{Instructor:} Dr. Khurram Jadoon \\
    \vspace{0.3cm} \\
    Fall 2025
}
...
\hline
pkg2020\_core.owl & 2.6 KB \\
pkg2020\_constrained.owl & 4.3 KB \\
pkg2020\_populated\_authors.owl & 3.8 MB \\
pkg2020\_step4\_affiliations.owl & 7.1 MB \\
pkg2020\_final.owl & 7.1 MB \\
\hline
\end{tabular}
\end{table}
...
\begin{itemize}
    ...
    \item \textbf{GraphDB}: Triple store with SPARQL endpoint
    \item \textbf{WebVOWL}: Online ontology visualization
    \item \textbf{Custom Flask App}: Interactive web-based explorer
\end{itemize}
...
\begin{enumerate}
    \item Open \texttt{owl/pkg2020\_constrained.owl} in Protégé
    \item Go to Window $\rightarrow$ Tabs $\rightarrow$ OntoGraf
    \item Select classes to visualize
    \item Export as image for reports
\end{enumerate}
